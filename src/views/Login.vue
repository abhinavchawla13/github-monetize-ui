<template>
  <div
    class="bg-auto bg-center h-full"
    style="background-image: url('https://images.unsplash.com/photo-1556075798-4825dfaaf498?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1500&q=80')"
  >
    <div
      class="absolute w-4/5 md:w-3/5 lg:w-1/4 h-40 inset-0 m-auto rounded-md shadow-lg"
